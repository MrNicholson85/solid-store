      ...
      <header class="bg-[#191919] text-theme-white pt-8 px-8 lg:px-0 relative z-50">
        ...
        <div class="container overflow-visible relative nav mx-auto flex items-center justify-between">
          ...
          <div class="flex items-center gap-6">
            ...
            {/* Cart Icon */}
            <button 
              class="hover:text-theme-orange transition relative" 
            ...
            >
              ...
              <Show when={getCartItemCount() > 0}>
                <span class="absolute -top-2 -right-2 bg-theme-orange text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
                  {getCartItemCount()}
                </span>
              </Show>
            </button>
