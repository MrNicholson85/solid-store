...
const Header = () => {
    return (
        <header class="bg-theme-black text-theme-white py-8 px-8 lg:px-24 border-b border-white/20">
            <div class="container mx-auto flex items-center justify-between">
                ...
                {/* Cart Icon */}
                <button class="hover:text-theme-orange transition" aria-label="Shopping Cart">
