...
const ProductCards = (props) => {
    return (
        <div class="product-cards container grid lg:flex gap-[30px] justify-between mb-[200px]">
            <div class="w-full lg:w-1/2 h-80 rounded-lg bg-cover overflow-hidden">
                <img src={props.bgImage} alt={props.title} class="w-full h-full object-cover"/>
            </div>
            <div class="bg-theme-light-gray flex items-center px-8 lg:px-0 rounded-lg w-full py-10 lg:w-1/2">
